...
def main():
    ...
    logger.info(
        f"distributed={args.distributed}, rank={args.rank}, world_size={args.world_size}, gpu={args.gpu}"
    )
...
def main_worker(gpu, args):
    ...
    # build dataset
    args.batch_size = int(args.batch_size / args.ngpus_per_node) if args.distributed else args.batch_size
    args.batch_size_val = int(args.batch_size_val / args.ngpus_per_node) if args.distributed else args.batch_size_val
    if args.distributed:
        args.workers = int((args.workers + args.ngpus_per_node - 1) / args.ngpus_per_node)
        args.workers_val = int((args.workers_val + args.ngpus_per_node - 1) / args.ngpus_per_node)
