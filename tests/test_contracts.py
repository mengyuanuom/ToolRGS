...
from model.droglr import DROGLRProjector, decode_lr_geometry
...
class ToolRGSContractsTest(unittest.TestCase):
    ...
    def test_droglr_projector_and_bounded_lr_decode(self):
    ...
    def test_asymmetric_targets_keep_original_size_but_canvas_balance(self):
